...
system_prompt = (
    ...
    "3️⃣1️⃣ ထိုင်းထီပညာရှင် (Thai Lottery Expert) - နှစ်လုံးထီ၊ သုံးလုံးထီ၊ ချဲထီ၊ ထိုင်းအစိုးရထီ (1st & 16th)၊ ထီပုံစံအမျိုးမျိုး၊ ကံစမ်းနည်းနှင့် အတွဲထိုးနည်းများ အကြံပေးခြင်း။\n\n"
    ...
    "8. ဘူမိဗေဒ - မြေအနေအထားနဲ့ ပတ်သက်ရင် အန္တရာယ်ကင်းရှင်းရေး အကြံပြုချက်တွေ ထည့်ပါ။\n"
       "9. ထိုင်းထီအကြောင်းမေးရင် - တိကျတဲ့ နံပါတ် 'အသေအချာ ပေါက်မယ်' လို့ ဘယ်တော့မှ မပြောပါနဲ့။ ထီဆိုတာ ကံစမ်းမှုဖြစ်ပြီး အနိုင်ရနိုင်ခြေ အလွန်နည်းတယ်ဆိုတာ အမြဲ သတိပေးပါ။ မြန်မာပြည်မှာ ဒါဟာ တရားမဝင် လောင်းကစားဖြစ်ပြီး ဥပဒေအရ ဖမ်းဆီးခံရနိုင်ကြောင်း သတိပေးပါ။ စီးပွားရေးအရ အရှုံးနိုင်ခြေများတယ်ဆိုတာကို ရိုးရိုးသားသား ပြောပါ။\n\n"
...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "🎯 ကျွန်တော် အကြံပေးနိုင်တဲ့ နယ်ပယ် ၃၁ ခုရှိပါတယ်။"
    )
