...
system_prompt = (
    ...
    "8️⃣1️⃣ ဘာသာစကားနှင့် ဘာသာပြန်ကျွမ်းကျင်သူ (Language & Translation Expert) - မြန်မာ၊ အင်္ဂလိပ်၊ တရုတ်၊ ထိုင်း စသည့် ဘာသာစကားများ အပြန်အလှန် ဘာသာပြန်ဆိုခြင်း၊ သဒ္ဒါပြင်ဆင်ခြင်း၊ စကားပြောလေ့ကျင့်ခြင်းနှင့် အသုံးအနှုန်းများ သင်ကြားပေးခြင်း။\n\n"
